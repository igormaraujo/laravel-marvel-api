        ...
        <div class="justify-between w-full mt-4 text-center lg:flex">
          <div class="w-full px-4 lg:w-1/3 md:w-1/2">
            ...
            <ul class="mb-8 space-y-2 text-sm list-none">
              ...
              <li>
                <a class="text-gray-300 hover:text-white">Characters</a>
              </li>
              <li>
                <a class="text-gray-300 hover:text-white">Comics</a>
              </li>
            </ul>
          </div>
          <div class="w-full px-4 lg:w-1/3 md:w-1/2">
            ...
            <ul class="mb-8 space-y-2 text-sm list-none">
              ...
              <li>
                <a class="text-gray-300 hover:text-white">Register</a>
              </li>
              <li>
                <a class="text-gray-300 hover:text-white">My Favorites</a>
              </li>
            </ul>
          </div>
        </div>
