    ...
    <nav class="bg-red-800">
      ...
      <div class="hidden md:hidden" id="mobile-menu">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          @class([
            'bg-red-900 text-white' => Route::is('characters.index'),
            'text-gray-300 hover:bg-red-700 hover:text-white' => !Route::is('characters.index'),
            'block py-2 rounded-md text-base font-medium pl-2'
          ])
          >Characters</a>
          ...
          @class([
            'bg-red-900 text-white' => Route::is('comics.index'),
            'text-gray-300 hover:bg-red-700 hover:text-white' => !Route::is('comics.index'),
            'block py-2 rounded-md text-base font-medium pl-2'
          ])
          >Comics</a>
          ...
          @class([
            'bg-red-900 text-white' => Route::is('favorites.index'),
            'text-gray-300 hover:bg-red-700 hover:text-white' => !Route::is('favorites.index'),
            'block py-2 rounded-md text-base font-medium pl-2'
          ])
          >My Favorites</a>
        </div>
