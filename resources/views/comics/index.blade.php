<x-guest-layout>
  ...
  <div class="flex">
    <input type="text" name="search" id="search"
      ...
      <select name="limit" id="limit" class="focus:ring-red-500 focus:border-red-500 border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 my-4"">
              ...
              @foreach ($comics['results'] as $comic)
                <tr>
                  <td class="whitespace-nowrap pl-4">
                    <button type="button" class="bg-white p-1 rounded-full text-gray-400 hover:text-red-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-red-800 focus:ring-white mx-auto">
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
              <div>
                <p class="text-sm text-gray-700">
                  Showing
                  <select name="limit" id="limit" class="focus:ring-red-500 focus:border-red-500 border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50"">
